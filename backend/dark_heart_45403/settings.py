"""
Django settings for dark_heart_45403 project.
...
ROOT_URLCONF = 'dark_heart_45403.urls'
...
WSGI_APPLICATION = 'dark_heart_45403.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_heart_45403 API",
    "DESCRIPTION": "API documentation for dark_heart_45403 App",
    "VERSION": "v1",
}
